    ...
    >
     <div className={styles.logo}>
        ...
        <Nav defaultActiveKey="/dashboard" className={styles.nav}>
          ...
          <Nav.Link onClick={() => handleNavClick('add-books')}  className={styles.navLink}>Add Books</Nav.Link>
          <Nav.Link onClick={() => handleNavClick('book-list')}  className={styles.navLink}>Book List</Nav.Link>
          <Nav.Link onClick={() => handleNavClick('book-issue')}  className={styles.navLink}>Issue Book</Nav.Link>
          <Nav.Link onClick={() => handleNavClick('book-return')}  className={styles.navLink}>Receive Book</Nav.Link> 
        </Nav>
